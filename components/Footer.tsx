    ...
    <footer className="bg-zinc-950 border-t border-white/5 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-zinc-600 text-sm font-mono" data-testid="text-copyright">
            © {new Date().getFullYear()} 337 Sleds and Customs. All rights reserved.
          </p>
          <div className="flex items-center space-x-4">
            <a href="#" className="p-2 bg-zinc-900 rounded-full text-zinc-400 hover:text-primary hover:bg-white/5 transition-all" data-testid="link-instagram">
              <Instagram className="w-5 h-5" />
            </a>
            <a href="#" className="p-2 bg-zinc-900 rounded-full text-zinc-400 hover:text-primary hover:bg-white/5 transition-all" data-testid="link-facebook">
