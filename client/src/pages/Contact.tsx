          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">123 Industrial Parkway, Unit 4B<br />Lafayette, LA 70508</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">(337) 555-0123</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">info@337sleds.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Mon - Fri: 8:00 AM - 6:00 PM<br />Sat: 9:00 AM - 2:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="h-64 bg-zinc-800 rounded-xl overflow-hidden border border-white/5 relative group">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Button variant="secondary" className="shadow-xl">Open in Maps</Button>
              </div>
            </div>
          </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="John Doe" {...field} className="bg-black/50 border-zinc-700 focus:border-primary text-white h-12" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="john@example.com" {...field} className="bg-black/50 border-zinc-700 focus:border-primary text-white h-12" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="(555) 123-4567" {...field} className="bg-black/50 border-zinc-700 focus:border-primary text-white h-12" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
