  ...
  return (
    <div className="min-h-screen pt-20 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Abstract mechanical parts background */}
        <img 
      ...
      <div className="flex-grow flex items-center justify-center relative z-10 p-4">
        <div className="max-w-2xl w-full text-center">
          ...
          <h1 className="font-display font-bold text-5xl md:text-7xl text-white mb-6 uppercase tracking-tight">
            Parts Shop <br />
          ...
          <div className="bg-zinc-900/80 border border-white/10 p-8 rounded-2xl backdrop-blur-sm max-w-md mx-auto">
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <Button type="submit" className="bg-primary text-black font-bold uppercase hover:bg-orange-500">
                Notify Me
              </Button>
            </form>
          </div>
          ...
          <div className="mt-16">
            <Link href="/services">
              <Button variant="link" className="text-zinc-500 hover:text-white uppercase font-mono tracking-widest text-xs">
                ← Back to Services
              </Button>
            </Link>
          </div>
